...
function POccupationMu3P4listExample() {
          ...
          <div className="calendar-tit">
            ...
            <h2 className="datetitle">
              <AppDatePicker
                ...
                showNow={false}
              />
              <span onClick={() => setOpen(true)}>{CommonUtil.convertDate(searchMonth, 'YYYY-MM', 'YYYY.MM')}</span>
            </h2>
...
export default POccupationMu3P4listExample;
