...
function POccupationMu3P5detail() {
              ...
              <div className="box-view-list">
                <ul className="view-list">
                  <li className="accumlate-list">
                    ...
                    <span className="text-desc-type1">0000-0000-0000</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="box-view-list">
                <ul className="view-list">
                  <li className="accumlate-list">
                    ...
                    <span className="text-desc-type1">항공운송지원서비스</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="box-view-list">
                <ul className="view-list">
                  <li className="accumlate-list">
                    ...
                    <span className="text-desc-type1">항공운송유지</span>
                  </li>
                </ul>
              </div>
            </div>
                        ...
                        <div className="box-view-list">
                          <ul className="view-list">
                            <li className="accumlate-list">
                              ...
                              <span className="text-desc-type1">사업장분류</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div className="box-view-list">
                          <ul className="view-list">
                            <li className="accumlate-list">
                              ...
                              <span className="text-desc-type1">사용부문</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div className="box-view-list">
                          <ul className="view-list">
                            <li className="accumlate-list">
                              ...
                              <span className="text-desc-type1">관리부서</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div className="box-view-list">
                          <ul className="view-list">
                            <li className="accumlate-list">
                              ...
                              <span className="text-desc-type1">관리자1</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div className="box-view-list">
                          <ul className="view-list">
                            <li className="accumlate-list">
                              ...
                              <span className="text-desc-type1">연락처1</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div className="box-view-list">
                          <ul className="view-list">
                            <li className="accumlate-list">
                              ...
                              <span className="text-desc-type1">이메일1</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div className="box-view-list">
                          <ul className="view-list">
                            <li className="accumlate-list">
                              ...
                              <span className="text-desc-type1">담당업무1</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div className="box-view-list">
                          <ul className="view-list">
                            <li className="accumlate-list">
                              ...
                              <span className="text-desc-type1">관리자2</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div className="box-view-list">
                          <ul className="view-list">
                            <li className="accumlate-list">
                              ...
                              <span className="text-desc-type1">연락처2</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div className="box-view-list">
                          <ul className="view-list">
                            <li className="accumlate-list">
                              ...
                              <span className="text-desc-type1">이메일2</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div className="box-view-list">
                          <ul className="view-list">
                            <li className="accumlate-list">
                              ...
                              <span className="text-desc-type1">담당업무2</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div className="box-view-list">
                          <ul className="view-list">
                            <li className="accumlate-list">
                              ...
                              <span className="text-desc-type1">안전관리</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div className="box-view-list">
                          <ul className="view-list">
                            <li className="accumlate-list">
                              ...
                              <span className="text-desc-type1">보건관리</span>
                            </li>
                          </ul>
                        </div>
                      </div>
...
export default POccupationMu3P5detail;
