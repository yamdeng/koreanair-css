    ...
    <>
      ...
      <div className="menu-tab-nav">
        <div className="menu-tab">
          <a href="javascript:void(0);" className="active" data-label="재해율">
            재해율
          </a>
          <a href="javascript:void(0);" data-label="강도율">
            강도율
          </a>
        </div>
      </div>
...
export default POccupationMu6P3list;
