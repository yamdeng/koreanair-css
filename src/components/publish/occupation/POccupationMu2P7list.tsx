    ...
    <>
      ...
      <div className="menu-tab-nav">
        <div className="menu-tab">
          <a href="javascript:void(0);" className="active" data-label="교육 현황">
            교육 현황
          </a>
          <a href="javascript:void(0);" data-label="개인별 현황">
            개인별 현황
          </a>
        </div>
      </div>
...
export default POccupationMu2P7list;
