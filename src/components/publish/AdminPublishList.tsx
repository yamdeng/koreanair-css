...
const moduleDirectoryPath = 'admin/';

function AdminPublishList({ keyword, checkedNewTab }) {
  const list = CommonUtil.getFilterListByMenuList(AdminPageInfo.list, keyword);
...
export default AdminPublishList;
