        ...
        <div className="pop_full_cont_box">
          ...
          <div className="menu-tab-nav">
            <div className="menu-tab">
              ...
              <a href="javascript:void(0);" className="active" data-label="HZR TOP RISK분석현황">
                HZR TOP RISK분석현황
              </a>
  ...
  return (
    <>
      <div>
        ...
        <AMO1Modal isOpen={isOpen} closeModal={closeModal} />
      </div>
    </>
  );
}

export default PAMO1Modal;
