  ...
  return (
    ...
    >
      <div className="popup-container">
        <h3 className="pop_title">Finding Category</h3>
                  ...
                  <div className="form-table">
                    <div className="form-cell wid50">
                      <div className="form-group wid100">
                        <AppTextInput label="Level 1" />
                      </div>
                    </div>
                    <div className="form-cell wid50">
                      <div className="form-group wid100">
                        <AppTextInput label="Level 2" />
                      </div>
                    </div>
                    <div className="form-cell wid50">
                      <div className="form-group wid100">
                        <AppTextInput label="Level 3" />
                      </div>
                    </div>
...
function MU3P4Modal() {
  ...
  return (
    <>
      <div>
        <h3>Finding Category 모달</h3>
        <p>
          <button className="button" onClick={() => setIsOpen(true)}>
            Finding Category 모달 open
          </button>
        </p>
